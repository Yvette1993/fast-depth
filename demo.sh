...
###kitti
#sudo python demo.py --data kitti --evaluate /home/lisa/fast-depth/results/kitti.samples=0.modality=rgb.arch=MobileNetSkipAdd.criterion=l1.lr=0.01.bs=8.pretrained=True/model_best.pth.tar
